...
public class ScoreScriptLv4 : MonoBehaviour
{
    ...
    PickleBurger fB;
    UIManager uiManager;
    GeneralScriptLv4 generalScript;

    // Start is called before the first frame update
    void Start()
    {
        uiManager = uIManager.GetComponent<UIManager>();
        fB = fourthBurger.GetComponent<PickleBurger>();
        tB = thirdBurger.GetComponent<CheeseBurgerW>();
        sB = secondBurger.GetComponent<CheeseBurgerB>();
        generalScript = gS.GetComponent<GeneralScriptLv4>();
    }
    ...
    public IEnumerator Next()
    {
        ...
        else if (generalScript.score == 20)
        {
            uiManager.isGameStarted = false;
