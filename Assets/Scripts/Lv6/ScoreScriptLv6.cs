...
public class ScoreScriptLv6 : MonoBehaviour
{
    ...
    TCBurgerBlue tB;
    UIManager uiManager;
    GeneralScriptLv6 generalScript;

    // Start is called before the first frame update
    void Start()
    {
        uiManager = uIManager.GetComponent<UIManager>();
        tB = thirdBurger.GetComponent<TCBurgerBlue>();
        sB = secondBurger.GetComponent<TCBurgerWhite>();
        generalScript = gS.GetComponent<GeneralScriptLv6>();
    }
    ...
    public IEnumerator Next()
    {
        ...
        else if (generalScript.score == 40)
        {
            uiManager.isGameStarted = false;
