...
public class GeneralScriptLv5 : MonoBehaviour
{
    ...
    UIManager uiManager;
    ScoreScriptLv5 scoreManager;
    ShurikenScript shurikenScript;

    public bool gameOver, isFirstFinished, isSecondFinished, isThirdFinished;

    void Start()
    {
        scoreManager = FindObjectOfType<ScoreScriptLv5>();
        comingIngAmount = 3;
        gameOver = false;
        uiManager = uIManager.GetComponent<UIManager>();
        shurikenScript = FindObjectOfType<ShurikenScript>();
        Time.timeScale = 0;
    ...
    public void NextBTN()
    {
        ...
        currentTime = startingTime;
        shurikenScript.remainedHeart = 3;
    }
