...
public class ScoreScriptLv7 : MonoBehaviour
{
    ...
    public GameObject uIManager, secondBurger, thirdBurger, fourthBurger, gS;

    TC2xBurgerRed sB;
    CheeseBurgerRed tB;
    TPCBurgerWhite fB;
    UIManager uiManager;
    GeneralScriptLv7 generalScript;

    // Start is called before the first frame update
    void Start()
    {
        uiManager = uIManager.GetComponent<UIManager>();
        fB = fourthBurger.GetComponent<TPCBurgerWhite>();
        tB = thirdBurger.GetComponent<CheeseBurgerRed>();
        sB = secondBurger.GetComponent<TC2xBurgerRed>();
        generalScript = gS.GetComponent<GeneralScriptLv7>();
    }
    ...
    public IEnumerator Next()
    {
        ...
        else if (generalScript.score == 28)
        {
            uiManager.isGameStarted = false;
        ...
        {
            uiManager.isGameStarted = false;
            mouthTypes[10].SetActive(true);
            browTypes[10].SetActive(true);
            mouthTypes[11].SetActive(false);
            browTypes[11].SetActive(false);
            animators[3].SetBool("isMad", true);
            yield return new WaitForSeconds(0.3f);
            likeDislikes[7].SetActive(true);
        ...
        {
            uiManager.isGameStarted = false;
            mouthTypes[9].SetActive(true);
            browTypes[9].SetActive(true);
            mouthTypes[11].SetActive(false);
            browTypes[11].SetActive(false);
            animators[3].SetBool("isHappy", true);
            yield return new WaitForSeconds(0.3f);
            likeDislikes[6].SetActive(true);
            dollar[1].SetActive(true);
        ...
        if (tB.score < 16)
        {
            ...
            moneyAmount[6].SetActive(true);
            yield return new WaitForSeconds(0.5f);
            dollar[2].SetActive(false);
            moneyAmount[6].SetActive(false);
            uiManager.isGameStarted = true;
            money += 0;
        }
        else if (tB.score == 16)
        ...
        if (fB.score < 28)
        {
            ...
            dollar[3].SetActive(true);
            moneyAmount[7].SetActive(true);
            yield return new WaitForSeconds(0.5f);
            dollar[3].SetActive(false);
            moneyAmount[7].SetActive(false);
            uiManager.isGameStarted = true;
            money += 0;
        }
        else if (fB.score == 28)
        ...
        likeDislikes[6].SetActive(false);
        likeDislikes[7].SetActive(false);
        totalScore = generalScript.score + tB.score + sB.score + fB.score;
        if (totalScore < 16)
        {
            Debug.Log("Try again!");
            yield return new WaitForSeconds(0.3f);
        ...
        else if (totalScore >= 16 && totalScore < 66)
        {
            Debug.Log("1 Star!");
            uiManager.isGameStarted = false;
            yield return new WaitForSeconds(0.3f);
