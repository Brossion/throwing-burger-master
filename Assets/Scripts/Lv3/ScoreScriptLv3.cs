...
public class ScoreScriptLv3 : MonoBehaviour
{
    ...
    ThirdBurgerLv3 tB;
    UIManager uiManager;
    GeneralScriptLv3 generalScript;

    // Start is called before the first frame update
    void Start()
    {
        uiManager = uIManager.GetComponent<UIManager>();
        tB = thirdBurger.GetComponent<ThirdBurgerLv3>();
        sB = secondBurger.GetComponent<SecondBurgerLv3>();
        generalScript = gS.GetComponent<GeneralScriptLv3>();
    }
