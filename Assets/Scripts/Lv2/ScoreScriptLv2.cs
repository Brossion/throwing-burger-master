...
public class ScoreScriptLv2 : MonoBehaviour
{
    ...
    ThirdBurgerLv2 tB;
    UIManager uiManager;
    GeneralScriptLv2 generalScript;

    // Start is called before the first frame update
    void Start()
    {
        uiManager = uIManager.GetComponent<UIManager>();
        tB = thirdBurger.GetComponent<ThirdBurgerLv2>();
        sB = secondBurger.GetComponent<SecondBurgerLv2>();
        generalScript = gS.GetComponent<GeneralScriptLv2>();
    }
